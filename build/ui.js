(() => {
  ...
  function LineHeightTab() {
    ...
    )), scanResult && /* @__PURE__ */ _("div", { style: { borderTop: "1px solid var(--color-border)" } }, issuesOnly.length > 0 ? /* @__PURE__ */ _("div", null, /* @__PURE__ */ _("div", { style: { padding: "8px 12px", backgroundColor: "var(--color-bg-warning-subtle)" } }, /* @__PURE__ */ _("div", { style: { fontSize: "11px", color: "var(--color-text-warning)", fontWeight: 600 } }, "\u26A0 ", issuesOnly.length, " issue", issuesOnly.length !== 1 ? "s" : "", " found")), /* @__PURE__ */ _("div", { class: "card-list", style: { maxHeight: "320px", overflowY: "auto" } }, issuesOnly.map((layer) => {
  ...
  // ../../../../../../private/var/folders/rv/rx3nzqwx1cj4wksbb12rzlgm0000gn/T/b15e9c8a-3d23-4d00-ac06-18247fb5158a/styles.js
...
`;
  ...
  function Plugin() {
    const [activeTab, setActiveTab] = d2("fonts");
    const [scanResult, setScanResult] = d2(null);
